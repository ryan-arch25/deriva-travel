...
const allDestinations = {
  douro: {
    ...
    photos: {
      hero: "https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=1200&q=85",
      grid: [
        { url: "https://images.unsplash.com/photo-1596422846242-5908b53faac6?w=600&q=80", label: "Local Wine" },
        { url: "https://images.unsplash.com/photo-1587899245146-96d0c5c51e76?w=600&q=80", label: "Quinta Stay" },
        { url: "https://images.unsplash.com/photo-1596422846242-5908b53faac6?w=600&q=80", label: "River Views" },
      ]
    }
  },
  alentejo: {
    ...
    photos: {
      hero: "https://images.unsplash.com/photo-1523544545777-4531a0479b7f?w=1200&q=85",
      grid: [
        { url: "https://images.unsplash.com/photo-1504279577054-acfeccf8fd52?w=600&q=80", label: "Rolling Plains" },
        { url: "https://images.unsplash.com/photo-1596422846242-5908b53faac6?w=600&q=80", label: "Alentejo Wine" },
  ...
  puglia: {
    ...
    photos: {
      ...
      grid: [
        ...
        { url: "https://images.unsplash.com/photo-1609137144813-7d9921338f24?w=600&q=80", label: "Trulli Houses" },
  ...
  kyoto: {
    ...
    photos: {
      ...
      grid: [
        ...
        { url: "https://images.unsplash.com/photo-1587899245146-96d0c5c51e76?w=600&q=80", label: "Sake & Drinks" },
...
const portugalRegions = [
  { name: "Lisbon", tag: "City · Food · Neighborhoods", 
    ...
    img: "https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=1200&q=85" 
  },
  { name: "Porto", tag: "Wine · River · Character", 
    ...
    img: "https://images.unsplash.com/photo-1555881400-69d8c8c9d82f?w=1200&q=85" 
  },
  ...
  ], img: "https://images.unsplash.com/photo-1596422846242-5908b53faac6?w=900&q=80" },
  ...
  ], img: "https://images.unsplash.com/photo-1523544545777-4531a0479b7f?w=900&q=80" },
  ...
  ], img: "https://images.unsplash.com/photo-1609137144813-7d9921338f24?w=900&q=80" },
];
      ...
      <div style={{ background: c.parchment, padding: "4rem 2.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1px", background: c.sand }}>
          {[
            ...
            { dest: "The Douro Valley", country: "Portugal", season: "Best: Sept · Oct", desc: "Terraced vineyards, family quintas, and a pace that genuinely resets you.", img: "https://images.unsplash.com/photo-1585208798174-6cedd86e019a?w=700&q=80" },
