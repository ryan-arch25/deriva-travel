...
const allDestinations = {
  douro: {
    ...
    photos: {
      hero: "https://images.unsplash.com/photo-1596422846242-5908b53faac6?w=1200&q=85",
      grid: [
        { url: "https://images.unsplash.com/photo-1547637589-f54c34f5d7a4?w=600&q=80", label: "Local Wine" },
  ...
  alentejo: {
    ...
    photos: {
      hero: "https://images.unsplash.com/photo-1563789031959-4c02bcb41319?w=1200&q=85",
      grid: [
        { url: "https://images.unsplash.com/photo-1504279577054-acfeccf8fd52?w=600&q=80", label: "Rolling Plains" },
        { url: "https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=600&q=80", label: "Alentejo Wine" },
...
const portugalRegions = [
  ...
  ], img: "https://images.unsplash.com/photo-1573708455466-47f93db93654?w=900&q=80" },
];
