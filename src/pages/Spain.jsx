      ...
      <div style={{ paddingTop: '60px' }}>
        <div style={{ backgroundColor: colors.parchment, borderBottom: `1px solid ${colors.sand}`, padding: '5rem 2rem 4rem' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            ...
            <h1 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(2.5rem, 6vw, 5rem)', fontWeight: '400', color: colors.ink, letterSpacing: '0.04em', marginBottom: '1rem', lineHeight: '1' }}>Spain</h1>
