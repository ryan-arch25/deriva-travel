...
export default function WorkWithMe() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    // In production this would send to an email/backend.
    ...
    return (
      <div style={{ backgroundColor: colors.cream, minHeight: '100vh' }}>
        ...
        <div style={{
          ...
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '2rem', fontWeight: '400', color: colors.ink, marginBottom: '1.5rem' }}>
      ...
      <div style={{ paddingTop: '60px' }}>
        ...
        <div style={{
          ...
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: '0.65rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: colors.tan, marginBottom: '1rem' }}>
              Work With Me
            </p>
            <h1 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: '400', color: colors.ink, letterSpacing: '0.03em', marginBottom: '1rem', lineHeight: '1.1' }}>
              Custom trip planning,<br />built from scratch.
            </h1>
            <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: '1rem', fontWeight: '300', color: colors.mid, maxWidth: '520px', lineHeight: '1.7' }}>
              Not a template. Not an algorithm. A plan that fits how you actually travel.
            </p>
          </div>
        </div>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '4rem 2rem' }}>
          <div style={{
            ...
            {/* WHAT I OFFER */}
            <div>
              <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: '0.65rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: colors.tan, marginBottom: '1.5rem' }}>
                What I Offer
              </p>
            ...
            <div>
              ...
              {HOW_IT_WORKS.map((step, i) => (
                <div key={step.num} style={{
                  ...
                  borderBottom: i < HOW_IT_WORKS.length - 1 ? `1px solid ${colors.sand}` : 'none',
                }}>
          ...
          <div style={{ borderTop: `1px solid ${colors.sand}`, paddingTop: '4rem' }}>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '1.8rem', fontWeight: '400', color: colors.ink, marginBottom: '0.5rem' }}>
              Tell me about your trip.
            </h2>
            <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: '0.875rem', fontWeight: '300', color: colors.mid, marginBottom: '2.5rem', lineHeight: '1.6' }}>
            ...
            <form onSubmit={handleSubmit} style={{ maxWidth: '620px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 1.5rem' }}>
                <div>
                  ...
                  <input id="name" name="name" type="text" required value={form.name} onChange={handleChange} style={inputStyle} placeholder="Your name" />
                </div>
                <div>
                  <label style={labelStyle} htmlFor="email">Email</label>
                  <input id="email" name="email" type="email" required value={form.email} onChange={handleChange} style={inputStyle} placeholder="your@email.com" />
                </div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 1.5rem' }}>
                <div>
                  <label style={labelStyle} htmlFor="dates">Travel dates</label>
                  <input id="dates" name="dates" type="text" value={form.dates} onChange={handleChange} style={inputStyle} placeholder="June 2025, flexible..." />
                </div>
                <div>
                  <label style={labelStyle} htmlFor="length">Trip length</label>
                  <input id="length" name="length" type="text" value={form.length} onChange={handleChange} style={inputStyle} placeholder="10 days, 2 weeks..." />
                </div>
              </div>
              ...
              <textarea
                ...
                placeholder="Slow and food-focused. Prefer smaller towns. Love markets and local wine bars..."
              />
              ...
              <textarea
                ...
                onChange={handleChange}
                style={{ ...inputStyle, resize: 'vertical', fontFamily: 'system-ui, sans-serif' }}
                placeholder="No big tourist sites, needs AC, vegetarian, allergies..."
              />
