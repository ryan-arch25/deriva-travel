...
PART1 = '''import { useState, useEffect, useRef } from 'react'
...
function ItineraryView({ itinerary, onReset }) {
  const exportPDF = () => {
    ...
    for (const day of itinerary.days) {
      ...
      // Large muted day number (gold blended over terracotta: #AC6F51)
...
target = os.path.expanduser('~/deriva/src/advisor/AdvisorDashboard.jsx')
